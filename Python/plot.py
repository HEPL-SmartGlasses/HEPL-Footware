...
# X Plot
	...
	axX.legend(['Truth', 'HEPL Optimal', 'HEPL Measured', 'HEPL Prediction'], fontsize=12)
...
# Y Plot
	...
	axY.legend(['Truth', 'HEPL Optimal', 'HEPL Measured', 'HEPL Prediction'], fontsize=12)

# Z Plot
	axZ = fig.add_subplot(3, 2, 4)
	...
	axZ.legend(['Truth', 'HEPL Optimal', 'HEPL Measured', 'HEPL Prediction'], fontsize=12)

# Gain Plot
	axK = fig.add_subplot(3, 2, 5)
